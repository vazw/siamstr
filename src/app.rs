            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1">
                <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <span class="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-pink-600 md:text-5xl sm:text-3xl">
                        "siamstr"
                        <small class="text-xs font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-pink-600 pt-10 md:text-md sm:text-xs pl-1 sm:pl-1 md:pl-5">
